...
import com.reserve.config.annotation.IsUser;
...
public class GuestController {
	...
	public ResponseBooking getTopics(@PathVariable("id") int guestId) throws GuestException {
	...
	public ResponseEntity<Integer> addGuestDetails(@RequestBody ResortReservation resort,
			@PathVariable("guestId") int guestId) throws GuestException{
		HttpHeaders headers = new HttpHeaders();
		if (resort == null) {
	...
	public ResponseEntity<Integer> addGuestDetails(@RequestBody DiningReservation dining,
			@PathVariable("guestId") int guestId) throws GuestException{
		HttpHeaders headers = new HttpHeaders();
		if (dining == null) {
			return new ResponseEntity<Integer>(HttpStatus.BAD_REQUEST);
